...
# read saved features
train_negative_unambiguous_df = pd.read_csv("data/Our_data_2_latest/accessions_site/clean_08_24/ProtT5_Final/train_negative_unambiguous_df.csv",header = 0)
train_positive_unambiguous_df = pd.read_csv("data/Our_data_2_latest/accessions_site/clean_08_24/ProtT5_Final/train_positive_unambiguous_df.csv",header = 0)
test_positive_pred_II_df = pd.read_csv("data/Our_data_2_latest/accessions_site/clean_08_24/ProtT5_Final/test_positive_pred_II_df.csv",header = 0)
test_negative_pred_II_df = pd.read_csv("data/Our_data_2_latest/accessions_site/clean_08_24/ProtT5_Final/test_negative_pred_II_df.csv",header = 0)
